...
def run(
        ...
        deep_sort_weights=WEIGHTS / 'osnet_x0_25_market1501.pt',  # model.pt path,
        config_deepsort=ROOT / 'strong_sort/configs/strong_sort.yaml',
...
def parse_opt():
    ...
    parser.add_argument('--config-deepsort', type=str, default='strong_sort/configs/strong_sort.yaml')
